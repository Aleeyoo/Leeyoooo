---
status: processed
wiki: "[[WIKI/四层Agent工程的隐藏代价]]"
---
# Agent 四层工程解法很对，但每一层都有张账单

前几天读到一篇讲 Agent 工程的文章，标题是《你的 Agent 为什么越跑越歪？四层工程解法》。素材很扎实，我一口气读完，基本认同——它把"Agent 越跑越歪"拆成了四层，每层都配了解法：

- 稳定性，治的是 Agent 在长链路任务里偏轨，解法是 Harness Engineering，也就是 Guides 加 Sensors；
- 可靠性，治的是单 Agent 失控、自我评估失灵，解法是多 Agent 架构，按场景选模式；
- 连续性，治的是每次对话从零开始，解法是 CLAUDE.md、Auto Memory，加上社区的 claude-mem；
- 成长性，治的是 AI 不会积累行为习惯，解法是 Hooks 加 Instinct 持续学习。
这套拆法我没意见，方向全对。
...
- Harness 治好了 Agent 偏轨，换来的是校验器本身会出错、Harness 会过拟合；
- 多 Agent 治好了单 Agent 失控，换来的是 token 暴涨约 15 倍、上下文碎片化；
- 记忆治好了重复缴上下文税，换来的是召回静默失败、记忆投毒；
- Instinct 治好了不积累习惯，换来的是把坏习惯也一起固化、不可调试、抗拒改变。
...
https://x.com/freeman1266/article/2062536801206804890

— [老金 (@freeman1266)](https://x.com/freeman1266/status/2062536801206804890) · 2026-06-04 22:07
