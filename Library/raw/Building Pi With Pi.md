...
![Weekly external volume and acceptance rate of Pi issues and pull requests](https://lucumr.pocoo.org/static/pi-issue-tracker-volume.png)
...
[^1]: To me, [clanker](https://en.wikipedia.org/wiki/Clanker) is a much preferable term for agent. Agency lies with humans, not with machines. Calling these things agents I still believe is a mistake, but alas.