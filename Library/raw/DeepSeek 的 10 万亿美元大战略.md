---
status: processed
wiki: "[[WIKI/DeepSeek十万亿美元战略]]"
---
# X 上的 宝玉：”DeepSeek 的 10 万亿美元大战略【译】” / X

https://x.com/dotey/status/2058421725256171718?s=20

作者：GDP ([@bookwormengr](https://x.com/@bookwormengr)) 标题：[DeepSeek's 10 trillion USD grand strategy](https://x.com/bookwormengr/status/2057909493250539891)

> 5月23日

你有没有想过，DeepSeek 到底打算怎么赚钱，而且是赚大钱？

他们没有像智谱（GLM）、月之暗面（MoonShot）和 MiniMax 那样推出有竞争力的编程订阅计划。他们没有多模态、语音或视频模型。时至今日，他们甚至连一个 Harness 都没有（虽然最近听说他们开始招人做了）。而且，DeepSeek 还长期致力于开源，乐此不疲地分享自己的“独家秘方”。这难道是疯了吗？还是纯粹在烧钱？那些正准备给他们投资 100 亿美元的投资人们，难道是在把钱往水里扔吗？

不，在我看来，恰恰相反！！！

在这里，我想聊聊我对他们至今所作所为的观察，以及他们似乎正在践行的战略。DeepSeek 创始人梁文锋的眼光显然盯着一个大得多的终极奖杯——他们不仅自己能冲击 1 万亿美元的市值，还能顺便帮中国催生出一个高达 10 万亿美元的产业巨兽！

![图像](https://pbs.twimg.com/media/HJD5PrPXIAArCQH?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HJD5oTjXQAARn8H?format=jpg&name=large)

## 先来算一笔好玩的 KV 缓存账：

来看看知名半导体分析机构 [@SemiAnalysis\_](https://x.com/@SemiAnalysis_) 发布的这条非常及时的推文：

![图像](https://pbs.twimg.com/media/HJD5r01WYAAxYSn?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HJD5vWZXMAAUa38?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HJD50aGWIAAj_kb?format=jpg&name=large)
...
对于长程任务来说，由于缓存体量极小，将其“转存”（Offloading）到固态硬盘（SSD）并在需要时重新加载，就变得极为划算。这就大大降低了对 HBM 的依赖。要知道，HBM 目前全球严重短缺，而且从中国 AI 硬件产业的角度来看，这也是制造难度极高的核心痛点。更绝的是，DeepSeek 还开发了一套能从 SSD 中以极高速度重新加载 KV 缓存的技术，具体细节都在他们的论文里：[https://arxiv.org/pdf/2602.21548](https://arxiv.org/pdf/2602.21548)

![图像](https://pbs.twimg.com/media/HJD54CgWgAEwkW4?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HJD57i0XkAAhT85?format=png&name=large)

## 然而，格局绝不仅仅局限于 NAND 和 SSD：

低功耗内存（LPDDR）同样蕴藏着巨大的潜力，可以用作存放模型权重（Weights）的“大后方”，并在需要时源源不断地“流式传输”到 HBM 中，从而进一步减轻 HBM 的容量压力。你可以参考这篇博客：[https://www.lmsys.org/blog/2025-09-25-gb200-part-2/](https://www.lmsys.org/blog/2025-09-25-gb200-part-2/) 。下面我用一张图来解释这套方案是如何运作的：

虽然 DeepSeek 并没有专门针对这一方案做特殊开发，但他们那拥有庞大专家数量、并且支持 4 位（4-bit）权重的混合专家模型架构，完美契合了这套方案，使得其实施起来易如反掌。

![图像](https://pbs.twimg.com/media/HJD5_D_XwAA1mE2?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HJD6Cj6W0AACsTq?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HJD6THnWkAAG2j0?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HJD6Wq2X0AEt0VH?format=png&name=large)

1. 论文（[https://arxiv.org/pdf/2601.07372）于](https://arxiv.org/pdf/2601.07372%EF%BC%89%E4%BA%8E) 2026 年第一季度推出，正如前面所说，它在某种意义上实现了“用内存（LPDDR）换算力”。下面的详细图表展示了在总体参数预算完全一致的情况下，Engram 带来的巨大性能跃升。

![图像](https://pbs.twimg.com/media/HJD6cITXAAAtJ2e?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HJD6nG-XIAEpDWg?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HJD6qnjXEAEnES_?format=jpg&name=large)

关于这些底层技术创新的详细拆解长文将在本周末发布，感兴趣的朋友欢迎关注我的 Substack 专栏：[https://polymath707.substack.com/](https://polymath707.substack.com/) ...