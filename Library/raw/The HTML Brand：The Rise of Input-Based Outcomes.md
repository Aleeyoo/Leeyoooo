...
![](https://pbs.twimg.com/media/HIN59UxXAAAW1SX.jpg)

## How creative work is shifting from traditional outputs to atomic system-led outcomes.

Last week we sent a founder a zip file containing two folders: /human, /agent, & a [readme.md](http://readme.md/). After a month of work, inside the agent folder, their entire brand was encoded as instructions via YAML, JSON, Markdown, HTML, CSS, SVG files. Upon receipt, they dropped the packet into Cursor, typed a prompt, and had a near-complete landing page that day.
...
![](https://pbs.twimg.com/media/HIK0BViWEAA0nGE.jpg)
...
![](https://pbs.twimg.com/media/HIK0RgAXkAAY5b6.jpg)
...
[📹 video](https://video.twimg.com/amplify_video/2054403147443888128/vid/avc1/474x270/WXAQQChZnFSygrfv.mp4?tag=27)

We recently helped build the atomic kit for [Type](http://www.type.com/) (see the real site that just launched!), a multiplayer AI workspace tool (thanks @fletchrichman). 
...
[📹 video](https://video.twimg.com/amplify_video/2054404016080121856/vid/avc1/1902x1080/XJtm6rF2wWWo2W85.mp4?tag=27)
...
[📹 video](https://video.twimg.com/amplify_video/2054403718209015808/vid/avc1/1902x1080/wG5U3BSq113nZWEJ.mp4?tag=27)
...
![](https://pbs.twimg.com/media/HIK196eXoAAlS7L.jpg)

![](https://pbs.twimg.com/media/HIK2GswXAAAHuE2.jpg)

![](https://pbs.twimg.com/media/HIK2T3JWAAAK43s.jpg)
...
![](https://pbs.twimg.com/media/HIK2vE5XIAEcgud.jpg)

## Vocabulary’s Value

Recently, [Diplo was asked about AI.](https://x.com/jameygannon/status/2043788602467913966?s=20) In his answer, he talked about how the best DJs in the world are often older than him because of their *vocabulary*; their accumulated knowledge of music.
...
![](https://pbs.twimg.com/media/HIK22u4WoAEDBHN.jpg)
...
One thing worth debating about (as did Nathaniel Whittemore [two days ago on his excellent podcast, AI Daily Brief](https://www.youtube.com/watch?v=NNxGQw1uQHc)) is that we think HTML is increasingly the right format for this kind of work.
...
(For a great technical read on this, see [Using Claude Code: The Unreasonable Effectiveness of HTML](https://x.com/trq212/status/2052809885763747935) by @[thariq](https://x.com/trq212).)

[📹 video](https://video.twimg.com/tweet_video/HIK3ChNWkAAIGCJ.mp4)

![](https://pbs.twimg.com/media/HIK3IvgWoAAniao.jpg)

![](https://pbs.twimg.com/media/HIK3ULiXEAIOm2m.jpg)

![](https://video.twimg.com/amplify_video/2054407389030260736/pl/G1wJshgtq5BdsSPA.m3u8?tag=27)

## **What Claude Design Changed For Us**

Our atomic kit concept predates Claude Design. We've been pushing in this direction since early this year, and our essay [*Building Brands for Humans and Agents*](https://www.notion.so/The-HTML-Brand-Input-Based-Outcomes-35ebe9a1f5f68010b369e2166b8a9f17?pvs=21) laid out the case for refactoring brand work into agent-readable formats.
...
![](https://pbs.twimg.com/media/HIK4_FNWkAAvwdM.jpg)

![](https://pbs.twimg.com/media/HIK5E4RXQAAiVRW.jpg)
...
[Jack Dorsey](https://x.com/jack) and [Roelof Botha](https://x.com/roelofbotha) recently published "[From Hierarchy to Intelligence](https://block.xyz/inside/from-hierarchy-to-intelligence)," arguing that the next generation of companies will be organized around what they call a "world model" - a continuously updated, machine-readable understanding of the business itself, rich enough that AI can act on it directly. Their bet is that understanding is the moat, and that the depth of that understanding compounds as the system runs.
...
![](https://pbs.twimg.com/media/HIK5Q7pWEAAmptY.jpg)
...
If you want to talk this nerdy stuff, please email us at: [hello@littleplains.co](mailto:hello@littleplains.co).

- Emmett & Alex

[Emmett Shine](https://x.com/emmettshine) and [Alex Leiphart](https://x.com/alexleiphart) are partners of [Little Plains](https://littleplains.co/), a New York studio working with awesome startups on brand, product, and the systems that hold both together.*

https://x.com/emmettshine/article/2054539694097015171

— [Emmett (@emmettshine)](https://x.com/emmettshine/status/2054539694097015171) · 2026-05-13 20:30
