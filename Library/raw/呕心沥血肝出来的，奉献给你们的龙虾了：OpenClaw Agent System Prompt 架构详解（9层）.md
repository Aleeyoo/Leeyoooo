---
status: processed
wiki: "[[WIKI/OpenClaw九层提示词架构]]"
---
# 呕心沥血肝出来的，奉献给你们的龙虾了：OpenClaw Agent System Prompt 架构详解（9层）

![](https://pbs.twimg.com/media/HCowlT1awAAinZD.jpg)
...
2. **间接控制 Layer 9（Inbound Context）** - 通过发送消息影响上下文适用场景：通过对话历史、引用消息影响 LLM 行为
优点：无需配置，自然交互
缺点：无法精确控制

## 大小对比表

> [https://abs-0.twimg.com/emoji/v2/svg/26a0.svg](https://abs-0.twimg.com/emoji/v2/svg/26a0.svg) 注意：以下数据为估算值，实际大小会因配置和运行时上下文而变化。框架层（Layer 1-6 + 9）理论上应该相同，但实际可能因工具定义、Skills 加载、运行时信息等差异而略有不同。
...
[https://abs-0.twimg.com/emoji/v2/svg/2705.svg](https://abs-0.twimg.com/emoji/v2/svg/2705.svg) 推荐的精简策略：
...
[https://abs-0.twimg.com/emoji/v2/svg/274c.svg](https://abs-0.twimg.com/emoji/v2/svg/274c.svg) 避免的做法：
...
[https://abs-0.twimg.com/emoji/v2/svg/2705.svg](https://abs-0.twimg.com/emoji/v2/svg/2705.svg) 推荐的使用策略：
...
https://x.com/servasyy_ai/article/2029489020208848966

— [huangserva (@servasyy_ai)](https://x.com/servasyy_ai/status/2029489020208848966) · 2026-03-05 17:27
