---
status: processed
wiki: "[[WIKI/多Agent分工协作]]"
---
# X 上的 Russell：“多智能体协作调查：Agent 到底该怎么分工” / X

https://x.com/Russell3402/status/2056331558223786416?s=20

![图像](https://pbs.twimg.com/media/HImKiKyaIAA0kWY?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImNDUdaUAAH1Zb?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImLz_La0AEC-9R?format=jpg&name=large)

单 agent 是默认形态。需求模糊、修改很小、步骤强依赖时，单 agent 往往最稳定。很多任务不需要多智能体，只需要更好的上下文和更短的反馈循环。

![图像](https://pbs.twimg.com/media/HImL6AcbYAALPYO?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImL_f5a8AAC6j2?format=jpg&name=large)

链式 pipeline 适合强顺序任务。比如先定位 bug，再写修复，再补测试，再 review。硬把这种任务并行化，通常只会让后面的 worker 在错误假设上浪费时间。

![图像](https://pbs.twimg.com/media/HImMFeMasAAzh3r?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImMbxVaAAA89B_?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImMluMaUAA8fXt?format=jpg&name=large)

Gateway routing 适合常驻多入口系统。它不是“一个任务拆给多个 agent”，而是“不同入口进入不同 agent”。OpenClaw 的多 agent 价值，很大一部分在这里。

![图像](https://pbs.twimg.com/media/HImMq4aa4AAMDVU?format=jpg&name=large)

Durable board 适合长期协作。任务、评论、handoff、阻塞状态、重试记录都落到持久化存储里。

## 调用链

![图像](https://pbs.twimg.com/media/HImNNMAbEAA5i7r?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImNddfaoAAtpad?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImNnPnbEAE_7re?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImNwYCacAIR58Z?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImN3cgaoAAYCTv?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImN_SXbMAEjVVi?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HImOSkgbQAA5qcr?format=jpg&name=large)
